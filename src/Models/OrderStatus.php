...
class OrderStatus extends Enum implements OrderStatusContract
{
	...
	protected static $openStatuses 			= [self::IN_CREATION, self::AWAITS_CONFIRMATION, self::PENDING, self::AWAITS_PAYMENT, self::PAID, self::DISPATCHED, self::ON_BILLING, self::IN_WAREHOUSE_PREPARATION, self::PROCESSING,self::REFUNDING];
	protected static $closedStatuses 		= [self::CANCELLED, self::COMPLETED, self::REFUNDED ];
	protected static $paidStatuses 			= [self::PAID, self::DISPATCHED, self::ON_BILLING, self::BILLED, self::COMPLETED, self::IN_WAREHOUSE_PREPARATION, self::PROCESSING,self::REFUNDING];
	protected static $stockStatuses 		= [self::IN_CREATION, self::AWAITS_CONFIRMATION, self::PENDING, self::AWAITS_PAYMENT, self::PAID, self::DISPATCHED, self::ON_BILLING, self::IN_WAREHOUSE_PREPARATION, self::PROCESSING];
